...
aarch64-buildroot-linux-gnu-gcc ec_master_test_RK3568_MADHT1505BA1.c  -I ../include/ -L ../lib/.libs -g -lethercat -o example
...
aarch64-buildroot-linux-gnu-gcc rk_test_two.c  -I ../include/ -L ../lib/.libs -L ./ -g -lmadht1505ba1 -lethercat -o rk_test_two
